...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='ptclcoin.conf'
CONFIGFOLDER='/root/.ptclcoin'
COIN_DAEMON='ptclcoind'
COIN_CLI='ptclcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/ptclcoin910/ptclcoin/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
