...
def main():
    ...
    # Filter out hosts with multiple ptclcoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple ptclcoin ports' % (ip_stats(ips)), file=sys.stderr)
