...
RESOURCES += src/qt/ptclcoin.qrc src/qt/ptclcoin_locale.qrc

TRANSLATIONS += src/qt/locale/ptclcoin_bg.ts \
                src/qt/locale/ptclcoin_de.ts \
                src/qt/locale/ptclcoin_en.ts \
                src/qt/locale/ptclcoin_es.ts \
                src/qt/locale/ptclcoin_fi.ts \
                src/qt/locale/ptclcoin_fr.ts \
                src/qt/locale/ptclcoin_it.ts \
                src/qt/locale/ptclcoin_ja.ts \
                src/qt/locale/ptclcoin_pl.ts \
                src/qt/locale/ptclcoin_pt.ts \
                src/qt/locale/ptclcoin_ru.ts \
                src/qt/locale/ptclcoin_sk.ts \
                src/qt/locale/ptclcoin_sv.ts \
                src/qt/locale/ptclcoin_vi.ts \
                src/qt/locale/ptclcoin_zh_CN.ts \
                src/qt/locale/ptclcoin_zh_TW.ts
