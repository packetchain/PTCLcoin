...
#define MyAppName "PTCL Core"
#define MyAppPublisher "2022 PTCL Core Developers"
#define MyAppURL "https://ptclcoin.net"
#define MyAppExeName "ptclcoin-qt.exe"
#define MyAppExtraData "https://explorer.ptclcoin.net/bootstraps/PTCL/bootstrap.zip"
...
[Files]
Source: ".\package\ptclcoin-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\PTCL\PTCL-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\PTCL\PTCL-Qt,strDataDir|{userappdata}\PTCL\}');
  Result := True;
end;
