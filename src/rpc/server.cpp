...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PTCL features */
        {"ptclcoin", "listmasternodes", &listmasternodes, true },
        {"ptclcoin", "getmasternodecount", &getmasternodecount, true },
        {"ptclcoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"ptclcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"ptclcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"ptclcoin", "masternodecurrent", &masternodecurrent, true },
        {"ptclcoin", "startmasternode", &startmasternode, true },
        {"ptclcoin", "createmasternodekey", &createmasternodekey, true },
        {"ptclcoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"ptclcoin", "listmasternodeconf", &listmasternodeconf, true },
        {"ptclcoin", "getmasternodestatus", &getmasternodestatus, true },
        {"ptclcoin", "getmasternodewinners", &getmasternodewinners, true },
        {"ptclcoin", "getmasternodescores", &getmasternodescores, true },
        {"ptclcoin", "preparebudget", &preparebudget, true },
        {"ptclcoin", "submitbudget", &submitbudget, true },
        {"ptclcoin", "mnbudgetvote", &mnbudgetvote, true },
        {"ptclcoin", "getbudgetvotes", &getbudgetvotes, true },
        {"ptclcoin", "getnextsuperblock", &getnextsuperblock, true },
        {"ptclcoin", "getbudgetprojection", &getbudgetprojection, true },
        {"ptclcoin", "getbudgetinfo", &getbudgetinfo, true },
        {"ptclcoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"ptclcoin", "mnfinalbudget", &mnfinalbudget, true },
        {"ptclcoin", "checkbudgets", &checkbudgets, true },
        {"ptclcoin", "mnsync", &mnsync, true },
        {"ptclcoin", "spork", &spork, true },
...
{
    return "> ptclcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51061/\n";
}
