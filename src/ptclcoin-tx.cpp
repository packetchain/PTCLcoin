...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PTCL ptclcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ptclcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ptclcoin transaction") + "\n" +
                               "  ptclcoin-tx [options] -create [commands]   " + _("Create hex-encoded ptclcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ptclcoin transaction
