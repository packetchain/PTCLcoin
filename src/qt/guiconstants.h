...
/* PTCL GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "PTCL"
#define QAPP_ORG_DOMAIN "ptclcoin.org"
#define QAPP_APP_NAME_DEFAULT "PTCL-Qt"
#define QAPP_APP_NAME_TESTNET "PTCL-Qt-testnet"
