...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            PTCLGUI* window = static_cast<PTCLGUI*>(parentWidget());
...
{
    PTCLGUI* gui = static_cast<PTCLGUI*>(parentWidget());
...
{
    hide();
    static_cast<PTCLGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("PTCL will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your PTCLs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
