...
/** Utility functions used by the PTCL Qt UI.
 */
namespace GUIUtil
{
...
// Render PTCL addresses in monospace font
...
// Parse "ptclcoin:" URI into recipient object, return true on successful parsing
