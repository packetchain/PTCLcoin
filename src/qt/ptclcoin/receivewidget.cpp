...
#include "qt/ptclcoin/forms/ui_receivewidget.h"
#include "qt/ptclcoin/requestdialog.h"
...
#include "qt/ptclcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(PTCLGUI* parent) :
    PWidget(parent),
