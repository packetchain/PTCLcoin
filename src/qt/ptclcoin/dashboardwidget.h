...
#include "qt/ptclcoin/furabstractlistitemdelegate.h"
#include "qt/ptclcoin/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/ptclcoin/txviewholder.h"
...
#include "config/ptclcoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(PTCLGUI* _window);
    ~DashboardWidget();
