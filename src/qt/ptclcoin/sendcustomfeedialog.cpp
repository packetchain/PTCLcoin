...
#include "qt/ptclcoin/sendcustomfeedialog.h"
#include "qt/ptclcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(PTCLGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &PTCLGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
