...
#include "qt/ptclcoin/forms/ui_topbar.h"
#include "qt/ptclcoin/loadingdialog.h"
#include "qt/ptclcoin/lockunlock.h"
#include "qt/ptclcoin/qtutils.h"
#include "qt/ptclcoin/receivedialog.h"
...
TopBar::TopBar(PTCLGUI* _mainWindow, QWidget* parent) : PWidget(_mainWindow, parent),
                                                        ui(new Ui::TopBar)
{
    ui->setupUi(this);
    ...
    ui->pushButtonConf->setButtonText("ptclcoin.conf");
...
void TopBar::onBtnConfClicked()
{
    ...
    if (!GUIUtil::openConfigfile())
        inform(tr("Unable to open ptclcoin.conf with default application"));
}
