...
#include "qt/ptclcoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(PTCLGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &PTCLGUI::openFAQ);
