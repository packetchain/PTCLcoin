...
#include "qt/ptclcoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/ptclcoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(PTCLGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendablePTCL,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendablePTCL,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendablePTCL,
    ...
    connect(ui->pushButton_UnspendablePTCL, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendablePTCL);});
    ...
    if (parent)
        connect(parent, &PTCLGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
