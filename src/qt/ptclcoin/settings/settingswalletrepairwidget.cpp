...
#include "qt/ptclcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ptclcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(PTCLGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to PTCLGUI::handleRestart()
