...
#include "qt/ptclcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/ptclcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(PTCLGUI* _window, QWidget *parent) :
