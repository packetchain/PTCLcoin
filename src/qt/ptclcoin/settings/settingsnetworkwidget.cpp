...
#include "qt/ptclcoin/settings/settingsnetworkwidget.h"
#include "qt/ptclcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ptclcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(PTCLGUI* _window, QWidget *parent) :
