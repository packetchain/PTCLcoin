...
#include "qt/ptclcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(PTCLGUI* _window, QWidget *parent) :
