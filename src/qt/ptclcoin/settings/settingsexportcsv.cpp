...
#include "qt/ptclcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(PTCLGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("PTCL_tx_csv_export(*.csv)") : tr("PTCL_addresses_csv_export(*.csv)"),
                                        nullptr);
