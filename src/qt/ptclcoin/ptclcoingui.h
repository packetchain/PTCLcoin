...
#ifndef PTCL_CORE_NEW_GUI_PTCLGUI_H
#define PTCL_CORE_NEW_GUI_PTCLGUI_H
...
#include "qt/ptclcoin/navmenuwidget.h"
#include "qt/ptclcoin/topbar.h"
#include "qt/ptclcoin/dashboardwidget.h"
#include "qt/ptclcoin/send.h"
#include "qt/ptclcoin/receivewidget.h"
#include "qt/ptclcoin/addresseswidget.h"
#include "qt/ptclcoin/masternodeswidget.h"
#include "qt/ptclcoin/snackbar.h"
#include "qt/ptclcoin/settings/settingswidget.h"
...
/**
  PTCL GUI main class. This class represents the main window of the PTCL UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PTCLGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PTCLGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~PTCLGUI();
...
#endif //PTCL_CORE_NEW_GUI_PTCLGUI_H
