...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(PTCL);
    unitlist.append(mPTCL);
    unitlist.append(uPTCL);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case PTCL:
        return QString("PTCL");
    case mPTCL:
        return QString("mPTCL");
    case uPTCL:
        return QString::fromUtf8("uPTCL");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZPTCL)
{
    QSettings settings;
...
QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZPTCL)
{
