...
{
  if (nHeight >  924500) return    30000 * COIN;
  if (nHeight >  880500) return    30000 * COIN;
  if (nHeight >  836500) return    28000 * COIN;
  if (nHeight >  792500) return    26000 * COIN;
  if (nHeight >  748500) return    24000 * COIN;
  if (nHeight >  704500) return    22000 * COIN;
  if (nHeight >  660500) return    20000 * COIN;
  if (nHeight >  616500) return    10000 * COIN;
  if (nHeight >  572500) return    9000 * COIN;
  if (nHeight >  528500) return    8500 * COIN;
  if (nHeight >  484500) return    8000 * COIN;
  if (nHeight >  440500) return    7500 * COIN;
  if (nHeight >  396500) return    7000 * COIN;
  if (nHeight >  352500) return    6500 * COIN;
  if (nHeight >  308500) return    6000 * COIN;
  if (nHeight >  220500) return    5500 * COIN;
  if (nHeight >  176500) return    5000 * COIN;
  if (nHeight >  132500) return    4500 * COIN;
  if (nHeight >   85500) return    4000 * COIN;
  if (nHeight >   44500) return    3500 * COIN;
...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    if (nHeight >  924500) return    20 * COIN;
    if (nHeight >  880500) return    37 * COIN;
    if (nHeight >  836500) return    40 * COIN;
    if (nHeight >  792500) return    43 * COIN;
    if (nHeight >  748500) return    46 * COIN;
    if (nHeight >  704500) return    49 * COIN;
    if (nHeight >  660500) return    52 * COIN;
    if (nHeight >  616500) return    49 * COIN;
    if (nHeight >  572500) return    46 * COIN;
    if (nHeight >  528500) return    43 * COIN;
    if (nHeight >  484500) return    40 * COIN;
    if (nHeight >  440500) return    37 * COIN;
    if (nHeight >  396500) return    34 * COIN;
    if (nHeight >  352500) return    31 * COIN;
    if (nHeight >  308500) return    28 * COIN;
    if (nHeight >  220500) return    25 * COIN;
    if (nHeight >  176500) return    22 * COIN;
    if (nHeight >  132500) return    19 * COIN;
    if (nHeight >   88500) return    16 * COIN;
    if (nHeight >   44500) return    13 * COIN;
    if (nHeight >     500) return    10 * COIN;
    if (nHeight >       1) return    20 * COIN;
    if (nHeight >       0) return    340000 * COIN;
...
{
  if (nHeight >  924500) return      18 * COIN;
  if (nHeight >  880500) return    33.3 * COIN;
  if (nHeight >  836500) return      36 * COIN;
  if (nHeight >  792500) return    38.7 * COIN;
  if (nHeight >  748500) return    41.4 * COIN;
  if (nHeight >  704500) return    44.1 * COIN;
  if (nHeight >  660500) return    46.8 * COIN;
  if (nHeight >  616500) return    44.1 * COIN;
  if (nHeight >  572500) return    41.4 * COIN;
  if (nHeight >  528500) return    38.7 * COIN;
  if (nHeight >  484500) return      36 * COIN;
  if (nHeight >  440500) return    33.3 * COIN;
  if (nHeight >  396500) return    30.6 * COIN;
  if (nHeight >  352500) return    27.9 * COIN;
  if (nHeight >  308500) return    25.2 * COIN;
  if (nHeight >  220500) return    22.5 * COIN;
  if (nHeight >  176500) return    19.8 * COIN;
  if (nHeight >  132500) return    17.1 * COIN;
  if (nHeight >   85500) return    14.7 * COIN;
  if (nHeight >   44500) return    11.7 * COIN;
  if (nHeight >     500) return       9 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 PTCL tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 PTCL tx -> 1 confirmation
