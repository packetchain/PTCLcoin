Contributing to PTCL Core
============================

The PTCL Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ptclcoin910/ptclcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the PTCL Core project, and is not to be
confused with overall PTCL Network Protocol consensus changes.

Whether a pull request is merged into PTCL Core rests with the project merge
...
Patches that change PTCL consensus rules are considerably more involved than
...
Where a patchset proposes to change the PTCL consensus, it must have been
...
The project leader is the release manager for each PTCL Core release.
